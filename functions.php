...
if ( ! function_exists( 'future_imperfect_setup' ) ) :
	...
	function future_imperfect_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'future-imperfect' ),
		) );
...
function future_imperfect_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'future-imperfect' ),
...
function future_imperfect_scripts() {
	...
	wp_enqueue_script( 'future-imperfect-jquery-min-script', get_template_directory_uri() . '/js/jquery.min.js', array(), '20151215', true );
	wp_enqueue_script( 'future-imperfect-util-script', get_template_directory_uri() . '/js/util.js', array(), '20151215', true );
	wp_enqueue_script( 'future-imperfect-skel-min-script', get_template_directory_uri() . '/js/skel.min.js', array(), '20151215', true );
	wp_enqueue_script( 'future-imperfect-main-script', get_template_directory_uri() . '/js/main.js', array(), '20151215', true );
